 ...
 * 保留所有权利
 */
package com.faw_qm.erp.client.ejbaction;
...
import com.faw_qm.erp.client.event.SplitMaterielEvent;
import com.faw_qm.erp.client.event.SplitMaterielEventResponse;
...
import com.faw_qm.erp.model.SameMaterialInfo;
import com.faw_qm.erp.util.IntePackSourceType;
import com.faw_qm.erp.util.MaterialServiceHelper;
import com.faw_qm.erp.util.PublishData;
...
public class SplitMaterielEJBAction extends EJBActionSupport
{
    ...
    public EventResponse perform(Event e) throws EventException
    {
        ...
        try
        {
            ...
            if(de.getActionType()==SplitMaterielEvent.PUBLISHBYBASELINE)
            {
            	...
            	publishPartsToERP(baselineid,partids,false,null);
            }
            if(de.getActionType()==SplitMaterielEvent.PUBLISHBYROUTE)
            {
            	...
            	publishPartsToERP(null,null,true,routeid);
            }
        ...
        throws QMException
    {
        try
        {
           ...
           // String xmlName = getVirtualPartNumber(aaa);
        	String xmlName = "";
//            Date now = new Date(); 
...
//            }
//          //CCBegin by dikefeng 20100423，为了使得在发布的时候知道本次新发的物料都有哪些
//            Vector filterPartVec=msservice.split1( routeID,partVersion,partRoute ,masterbsoid);
//            
//            if(filterPartVec==null||filterPartVec.size()==0)
//             return;
////            String packid = createIntePack(xmlName, baselineiD, isPublishRoute, routeID);
...
//        String partNumber = "";
//        try {
//        	PublishData cs = new PublishData();
