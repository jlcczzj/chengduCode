...
import com.faw_qm.erp.client.event.PublicTechnicsEvent;
import com.faw_qm.erp.client.event.PublicTechnicsEventResponse;
    ...
    public EventResponse perform(Event e) throws EventException
    {
        ...
        try
        {
            ...
            if(de.getActionType() == PublicTechnicsEvent.REALEASE)
            {
                ...
                RequestHelper.request("MaterialSplitService", "publicTechnics",
