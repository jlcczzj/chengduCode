...
import com.faw_qm.erp.client.ejbaction.SplitMaterielEJBAction;
 ...
 * @version 1.0
 */
public class ErCiBGForErp implements Serializable
{
    public ErCiBGForErp()
    {
        super();
...
//            partVersion =LoadHelper.getValue("partVersion", nv, 1);
//            partRoute =LoadHelper.getValue("partRoute", nv, 1);
//            masterbsoid =LoadHelper.getValue("masterbsoid", nv, 1);
//            
//            //版本、路线，masterid
...
//                ejbAction.publishPartsToERP1(baselineifc.getBsoID(),ac,ac1,false,null,partVersion,partRoute,masterbsoid);
//                flag = true;
//            }
//            }
//            else
            ...
            Vector return_objects)
    {
        ...
        try
        {
            ...
            if(route.size()!=0){
              ...
              ejbAction.publishPartsToERP(null,null,true,routeifc.getBsoID());
              flag = true;
