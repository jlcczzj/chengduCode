/**
 * 生成程序QMCompositiveTypeRB.java	1.0              2007-9-24
 * 版权归启明信息技术股份有限公司所有
...
public class IntePackSourceTypeRB extends ListResourceBundle
{
    ...
    {
        contents = (new Object[][]{
        		{"com.faw_qm.erp.QMCompositiveType.PROMULGATENOTIFY",
                "promulgateNotify,采用通知书,采用通知书状态,10,true,true"}
        		,
                {"com.faw_qm.erp.QMCompositiveType.ADOPTNOTICE",
                "adoptNotice,更改采用通知书,更改采用通知书状态,20,false,true"}
        		,
                {"com.faw_qm.erp.QMCompositiveType.BASELINE",
                "baseLine,基线,基线状态,30,false,true"}
        		,
        		{"com.faw_qm.erp.QMCompositiveType.technicsRouteList",
