...
import com.faw_qm.erp.ejb.service.MaterialSplitServiceEJB;
...
//		System.out.println("00000000000========");
		result = select.executeQuery("select * from MESData1");
//		System.out.println("1111111111========"+result);
		//ArrayList part=new ArrayList();
//		获得所有的IBA属性定义
		PersistService pService=(PersistService)EJBServiceHelper.getPersistService();
//		System.out.println("aaaaaaaaaaaa1111111111========");
		QMQuery definitionQuery=new QMQuery("StringDefinition");
//		System.out.println("aaaaaaaaaaaa2222222222222222========");
		Collection definCol=pService.findValueInfo(definitionQuery);
//		System.out.println("aaaaaaaaaaaa33333333333333333333333========");
...
//    		System.out.println("jieguo  ========"+mainRoute);
//    		System.out.println("jieguo  ========"+masterid);
...
//				这里为什么直接就是N呢？questions
				...
				if(usageLinkList!=null&&usageLinkList.size()>0)
				{
					...
					while(linkIte.hasNext())
					{
						...
						mStructureIfc.setParentNumber(partIfc.getPartNumber());
						mStructureIfc.setChildNumber(sonMaster.getPartNumber());
						mStructureIfc.setQuantity(sonLink.getQuantity());
								// xieb应该设置为int型。
...
//				System.out.println("routeCodeListrouteCodeList========="+routeCodeList);
				...
				for(int m = routeCodeList.size() - 1; m >= 0; m--)
				{
					...
					String makeCodeNameStr = RemoteProperty.getProperty("com.faw_qm.erp.routecode." + routeCode);
...
//						routeCodeMap.put(makeCodeNameStr, "0");
					...
					for(int k = m-1; k >= 0; k--){
						...
						String makeCodeNameStr1 = RemoteProperty.getProperty("com.faw_qm.erp.routecode." + routeCode1);
...
//								如果路线单位与制造路线的路线单位相同，则设置为虚拟件
						...
						if(m == 0)
						{
//							System.out.println("mSplitIfcmSplitIfcmSplitIfcmSplitIfcddddddddddddddddddddddddddddd========="+mSplitIfc.getMaterialNumber());
							if(usageLinkList != null && usageLinkList.size() > 0)
							{
...
//					System.out.println("iiiiiiiiiiiiiiiiiiiiii=========="+ii);
			     ...
			     String k1 = RemoteProperty.getProperty("com.faw_qm.erp.routecode." + ifc.getRouteCode());
			     if(ii!=objs.length-1)
			     {
...
//			    	 String er="";
			    	 ...
			    	 for(int dd =0 ;dd<vvv.size();dd++){
			    		 ...
			    		 String kkkkk=RemoteProperty.getProperty("com.faw_qm.erp.routecode." + ifcdd.getRouteCode());
...
//			      
//			      String k2 = RemoteProperty.getProperty("com.faw_qm.erp.routecode." + ifc1.getRouteCode());
...
//		}
    	...
    	String makeCodeNameStr1 = RemoteProperty.getProperty("com.faw_qm.erp.routecode." + ms.getRCode());
...
//    		System.out.println("asasasasas=========0628======="+as);
    		for(int x =0;x<as.size()-1;x++){
    			...
    			String x11 = RemoteProperty.getProperty("com.faw_qm.erp.routecode." + x1);
    			boolean boobean=false;
    			int xx=x;
...
//    				System.out.println("sssssssssssssssss==========--------------"+xc);
    				String xc2 = RemoteProperty.getProperty("com.faw_qm.erp.routecode." + xc);
