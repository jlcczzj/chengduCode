 ...
 * @version 1.0
 */
public class PublishBomForErpHomeDelegate implements BsoHomeDelegate
{
    /**
     * 
     */
    public PublishBomForErpHomeDelegate()
    {
        super();
    }

    private PublishBomForErpHome home = null;
    ...
    {
        if(!(obj instanceof PublishBomForErpHome))
        {
            Object[] objs = {obj.getClass(), "PublishBomForErpHome"};
            throw new QMRuntimeException(
                    "com.faw_qm.framework.util.FrameworkResource", "70", objs);
        }
        home = (PublishBomForErpHome) obj;
    }
}
