 ...
 * @author 罗桥
 */
public class CompletPartLinkHomeDelegate implements BsoHomeDelegate
{

    //home接口
    private CompletPartLinkHome home = null;
    ...
    {
        if (!(obj instanceof CompletPartLinkHome))
        {
            Object[] objs =
                    {
