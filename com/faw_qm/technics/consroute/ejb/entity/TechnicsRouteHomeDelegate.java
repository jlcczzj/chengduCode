 ...
 * @version 1.0
 */
public class TechnicsRouteHomeDelegate implements BsoHomeDelegate
{
    private TechnicsRouteHome home = null;

    public void init(Object obj)
    {
        if(!(obj instanceof TechnicsRouteHome))
        {
            Object[] objs = {obj.getClass(), "TechnicsRouteHome"};
            throw new QMRuntimeException("com.faw_qm.framework.util.FrameworkResource", "70", objs);
        }
        home = (TechnicsRouteHome)obj;
    }
