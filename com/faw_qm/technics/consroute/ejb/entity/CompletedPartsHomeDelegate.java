 ...
 * @author 罗桥
 */
public class CompletedPartsHomeDelegate implements BsoHomeDelegate
{

    //home接口
    private CompletedPartsHome home = null;
    ...
    {
        if (!(obj instanceof CompletedPartsHome))
        {
            Object[] objs =
                    {
