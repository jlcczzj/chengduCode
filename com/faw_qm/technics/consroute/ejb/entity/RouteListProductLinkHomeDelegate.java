 ...
 * @version 1.0
 */
public class RouteListProductLinkHomeDelegate implements BsoHomeDelegate
{
    private RouteListProductLinkHome home = null;

    public void init(Object obj)
    {
        if(!(obj instanceof RouteListProductLinkHome))
        {
            Object[] objs = {obj.getClass(), "RouteListProductLinkHome"};
            throw new QMRuntimeException("com.faw_qm.framework.util.FrameworkResource", "70", objs);
        }
        home = (RouteListProductLinkHome)obj;
    }
