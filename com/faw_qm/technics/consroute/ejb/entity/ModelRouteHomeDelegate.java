...
public class ModelRouteHomeDelegate implements BsoHomeDelegate
{
    private ModelRouteHome home = null;

    public void init(Object obj) 
    {
        if(!(obj instanceof ModelRouteHome))
        {
            Object[] objs = {obj.getClass(), "ModelRouteHome"};
            throw new QMRuntimeException("com.faw_qm.framework.util.FrameworkResource", "70", objs);
        }
        home = (ModelRouteHome)obj;
    }
