 ...
 * @author 罗桥
 */
public class CompletListLinkHomeDelegate implements BsoHomeDelegate
{

    //home接口
    private CompletListLinkHome home = null;
    ...
    {
        if (!(obj instanceof CompletListLinkHome))
        {
            Object[] objs =
                    {
