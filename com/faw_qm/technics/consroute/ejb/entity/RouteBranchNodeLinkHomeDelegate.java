 ...
 * @version 1.0
 */
public class RouteBranchNodeLinkHomeDelegate implements BsoHomeDelegate
{
    private RouteBranchNodeLinkHome home = null;

    public void init(Object obj) 
    {
        if(!(obj instanceof RouteBranchNodeLinkHome))
        {
            Object[] objs = {obj.getClass(), "RouteBranchNodeLinkHome"};
            throw new QMRuntimeException("com.faw_qm.framework.util.FrameworkResource", "70", objs);
        }
        home = (RouteBranchNodeLinkHome)obj;
    }
