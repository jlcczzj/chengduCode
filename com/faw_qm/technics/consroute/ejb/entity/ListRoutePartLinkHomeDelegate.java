...
public class ListRoutePartLinkHomeDelegate implements BsoHomeDelegate
{
    private ListRoutePartLinkHome home = null;

    public void init(Object obj) 
    {
        if(!(obj instanceof ListRoutePartLinkHome))
        {
            Object[] objs = {obj.getClass(), "ListRoutePartLinkHome"};
            throw new QMRuntimeException("com.faw_qm.framework.util.FrameworkResource", "70", objs);
        }
        home = (ListRoutePartLinkHome)obj;
    }
