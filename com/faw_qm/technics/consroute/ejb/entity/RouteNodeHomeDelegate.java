 ...
 * @version 1.0
 */
public class RouteNodeHomeDelegate implements BsoHomeDelegate
{
    private RouteNodeHome home = null;

    public void init(Object obj) 
    {
        if(!(obj instanceof RouteNodeHome))
        {
            Object[] objs = {obj.getClass(), "RouteNodeHome"};
            throw new QMRuntimeException("com.faw_qm.framework.util.FrameworkResource", "70", objs);
        }
        home = (RouteNodeHome)obj;
    }
