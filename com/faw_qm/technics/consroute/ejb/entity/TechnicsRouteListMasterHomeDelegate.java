...
public class TechnicsRouteListMasterHomeDelegate implements BsoHomeDelegate
{

    public TechnicsRouteListMasterHomeDelegate()
    {

    }

    private TechnicsRouteListMasterHome home = null;

    public void init(Object obj) 
    {
        if(!(obj instanceof TechnicsRouteListMasterHome))
        {
            Object[] objs = {obj.getClass(), "TechnicsRouteListMasterHome"};
            throw new QMRuntimeException("com.faw_qm.framework.util.FrameworkResource", "70", objs);
        }
        home = (TechnicsRouteListMasterHome)obj;
    }
