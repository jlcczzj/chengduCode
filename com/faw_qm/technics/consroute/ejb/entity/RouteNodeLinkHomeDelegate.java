 ...
 * @version 1.0
 */
public class RouteNodeLinkHomeDelegate implements BsoHomeDelegate
{
    private RouteNodeLinkHome home = null;

    public void init(Object obj) 
    {
        if(!(obj instanceof RouteNodeLinkHome))
        {
            Object[] objs = {obj.getClass(), "RouteNodeLinkHome"};
            throw new QMRuntimeException("com.faw_qm.framework.util.FrameworkResource", "70", objs);
        }
        home = (RouteNodeLinkHome)obj;
    }
