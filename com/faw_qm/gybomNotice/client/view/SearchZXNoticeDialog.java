...
public class SearchZXNoticeDialog extends JDialog
{
    ...
    void jbInit() throws Exception
    {
        ...
        createrindex = headslist.indexOf("创建者");
        createTimeindex = headslist.indexOf("创建时间");
        ...
        createrLable.setText("创建者");
        modifyLable.setText("更新者");
        publishDataLable.setText("发布日期");
