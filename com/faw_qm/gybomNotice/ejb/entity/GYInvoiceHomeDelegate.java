 ...
 * <p>Title:变更请求Home方法代理实现类 </p>
 * <p>Description: 变更请求Home方法代理实现类</p>
 * @version 1.0
 */
public class GYInvoiceHomeDelegate implements BsoHomeDelegate{
	
	
	private GYInvoiceHome home = null;
	...
	{
        if (!(obj instanceof GYInvoiceHome))
        {
            Object[] objs ={obj.getClass(), "GYInvoiceHome"};
            throw new QMRuntimeException(
                    "com.faw_qm.framework.util.FrameworkResource", "70", objs);
        }
        home = (GYInvoiceHome) obj;
