...
public abstract class GYBomAdoptNoticePartLinkEJB extends BsoReferenceEJB
{


    /**
     * 获得BsoName
     * @return BsoName "GYBomAdoptNoticePartLink"
     */
    public String getBsoName()
    {
        return "GYBomAdoptNoticePartLink";
    } 
     ...
     *@return 采用标识
     */
	public abstract String getAdoptBs() ;
    /**
     * 设置采用标识
     *@param 采用标识
     */
	public abstract void setAdoptBs(String adoptBs);
    /**
     * 获得采用取消零件
     *@return 采用取消零件
     */
	public abstract String getLinkPart() ;
    /**
     * 设置采用取消零件
     *@param 采用取消零件
     */
	public abstract void setLinkPart(String linkPart);
    /**
     * 获得版本
     *@return 版本
     */
    ...
    /**
	  ...
	  public BaseValueIfc getValueInfo() throws QMException {
		  GYBomAdoptNoticePartLinkInfo info = new GYBomAdoptNoticePartLinkInfo();
	      setValueInfo(info);
	      return info;
	  }
    ...
    public void setValueInfo(BaseValueIfc info) throws QMException {
		...
		GYBomAdoptNoticePartLinkInfo cqInfo = (GYBomAdoptNoticePartLinkInfo) info;
		cqInfo.setAdoptBs(this.getAdoptBs());
		cqInfo.setLevel1(this.getLevel1());
		cqInfo.setLifecyclestate(this.getLifecyclestate());
		cqInfo.setLinkPart(this.getLinkPart());
