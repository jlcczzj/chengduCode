 ...
 */
public class ExportFirstLeveList extends HttpServlet
{
            ...
            throws javax.servlet.ServletException, java.io.IOException
    {
        ...
        try
        {
            ...
            String dwbs = request.getParameter("dwbs");
            if (VERBOSE)
            {
                System.out.println("id:1111111111111 " + id);
...
//            vec = (Vector)helper.getExportFirstLeveList(id, carModelCode, dwbs);
            System.out.println("start   :1getExportBOMList11 ");
            vec = (Vector)helper.getExportBOMList(id, carModelCode, dwbs);
            //CCEnd SS1
