 ...
 * @version 1.0
 */
public class MaterialPartStructureHomeDelegate implements BsoHomeDelegate
{
    /**
     * 
     */
    public MaterialPartStructureHomeDelegate()
    {
        super();
    }

    private MaterialPartStructureHome home = null;
    ...
    {
        if(!(obj instanceof MaterialPartStructureHome))
        {
            Object[] objs = {obj.getClass(), "JFMaterialPartStructureHome"};
            throw new QMRuntimeException(
                    "com.faw_qm.framework.util.FrameworkResource", "70", objs);
        }
        home = (MaterialPartStructureHome) obj;
    }
}
