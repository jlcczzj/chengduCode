/**
 * 生成程序PromulgateNotifyHomeDelegate.java   1.0              2006-11-6
 * 版权归启明信息技术股份有限公司所有
...
/**
 * <p>Title: 采用通知书接口代理</p>
 * <p>Description: 采用通知书接口代理</p>
 * <p>Copyright: Copyright (c) 2006</p>
 * <p>Company: 启明信息技术股份有限公司</p>
 * @author 蔡丽娜
 * @version 1.0
 */
public class PromulgateNotifyHomeDelegate implements BsoHomeDelegate
{
    private PromulgateNotifyHome home = null;

    public void init(Object obj)
    {
        if(!(obj instanceof PromulgateNotifyHome))
        {
            Object[] objs = {obj.getClass(), "JFPromulgateNotifyHome"};
            throw new QMRuntimeException(
                    "com.faw_qm.framework.util.FrameworkResource", "70", objs);
        }
        home = (PromulgateNotifyHome) obj;
    }
