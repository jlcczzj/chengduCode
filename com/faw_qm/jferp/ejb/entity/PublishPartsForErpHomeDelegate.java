 ...
 * @version 1.0
 */
public class PublishPartsForErpHomeDelegate implements BsoHomeDelegate
{
    /**
     * 
     */
    public PublishPartsForErpHomeDelegate()
    {
        super();
    }

    private PublishPartsForErpHome home = null;
    ...
    {
        if(!(obj instanceof PublishPartsForErpHome))
        {
            Object[] objs = {obj.getClass(), "JFPublishPartsForErpHome"};
            throw new QMRuntimeException(
                    "com.faw_qm.framework.util.FrameworkResource", "70", objs);
        }
        home = (PublishPartsForErpHome) obj;
    }
}
