 ...
 * @version 1.0
 */
public class FileNameLinkHomeDelegate implements BsoHomeDelegate
{
    private FileNameLinkHome home = null;

    public void init(Object obj)
    {
        if(!(obj instanceof FileNameLinkHome))
        {
            Object[] objs = {obj.getClass(), "JFFileNameLinkHome"};
            throw new QMRuntimeException(
                    "com.faw_qm.framework.util.FrameworkResource", "70", objs);
        }
        home = (FileNameLinkHome) obj;
    }
