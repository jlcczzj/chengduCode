...
import com.faw_qm.jferp.exception.IntePackException;
...
import com.faw_qm.jferp.util.TechnicsDataPublisher;
...
//        }
     ...
     * @throws QMExcepiton
     */
    public IntePackInfo publishIntePack(String id ,String xmlName,Collection coll,Vector filterParts,HashMap scbbMap,Collection vec)throws QMException
    {
    	try{
    	BaseDataPublisher.setXmlName(xmlName);
    	BaseDataPublisher.setColleciton(coll);
    	...
    	//CCEnd SS1
    	BaseDataPublisher.setScbb(scbbMap);
