 ...
 * SS5 尝试解决发布中的一个问题，刷新对象报空指针。 liunan 2016-10-31
 */
			...
			if(Vector!=null){
				...
				while(i.hasNext()){
					...
					//CCEnd SS5
		             ...
		             if(routeState.equals("取消")||routeState.equals("废弃")){
		            	 c.remove(info);
		             }
				}
			}
...
////CCBegin SS3
			...
			boolean hbbs = techInfo.getIsAdopt(); //合并装配路线标识
			if(hbbs){
				if(routeOtherCode != ""){
