/** 生成程序CappLMRB_en_US.java	1.1  2003/08/08
 * 版权归一汽启明公司所有
 * 本程序属一汽启明公司的私有机要资料
 * 未经本公司授权，不得非法传播和盗用
 * 可在本公司授权范围内，使用本程序
...
public class CappLMRB_en_US extends java.util.ListResourceBundle
{

    public CappLMRB_en_US()
    {
    }
    ...
    static final Object contents[][] =
          ...
          //2008.03.09 徐德政改，将“项目组”改为“工作组”
            ...
            //End CR2
            ,
            {"toolbar.icons", "public_createObj,public_updateObj,public_deleteObj,public_viewObj,Spacer,public_checkInObj,public_checkOutObj,public_repealObj,Spacer,public_copy,public_paste,Spacer,public_search"}
            ,
            {"toolbar.text",
            "创建,更新,删除,查看,Spacer,检入,检出,撤消检出,Spacer,复制,粘贴,Spacer,搜索"}
            ,
            {"techAction", "添加工艺规程"}
            ,
            {"eqAction", "添加设备关联"}
            ...
            ,
            {"37",
            "尚未指定存放当前对象的副本的资料夹。必须给定检出资料夹，才能检出。"}
            ,
            ...
            ,
            {"41",
            "设备列表和工装列表必须都添加有数据，且您所选择的设备和工装中至少有一项是一条数据，才能入库。"}
            ,
           ...
           ,
            ...
            {"technicsTypeForTechnicsStepJPanel",
            "工艺类信息"}
            ,
            {"flowdrawing", "制件流程图"}
            ,
            {"0", "测试"}
            ,
            {"Help/Capp/QMTechnics",
            "help/zh_cn/capp/index.html"}
            ,
    ...
    {
        CappLMRB_en_US cappLMRB_en_US1 = new CappLMRB_en_US();
    }
}
