...
public class CdTechnicsStepJPanel extends TechnicsStepJPanel
{
    /**工序维护面板*/
...
//    private GridBagLayout gridBagLayout1 = new GridBagLayout();
     ...
     */
    public CdTechnicsStepJPanel(JFrame parent)
    {
        try
        {
            parentJFrame = parent;
     ...
     */
    public CdTechnicsStepJPanel(JFrame parent, BaseValueIfc technics)
    {
        try
        {
            parentJFrame = parent;
            ...
            throws Exception
    {
        ...
        numJLabel.setMaximumSize(new Dimension(73, 22));
        numJLabel.setMinimumSize(new Dimension(73, 22));
        numJLabel.setPreferredSize(new Dimension(73, 22));
        numJLabel.setHorizontalAlignment(SwingConstants.RIGHT);
        numJLabel.setHorizontalTextPosition(SwingConstants.RIGHT);
        numJLabel.setText("*过程编号");
...
//        descStepNumberJLabel.setPreferredSize(new Dimension(48, 22));
        descStepNumberJLabel.setMaximumSize(new Dimension(73, 22));
        descStepNumberJLabel.setMinimumSize(new Dimension(73, 22));
        descStepNumberJLabel.setPreferredSize(new Dimension(73, 22));
        //薛凯 修改结束
...
//      薛凯修改 20080219 修改原因：在工艺规程中在工艺下创建工序,工序编号为必输项字段前有*
        ...
        descStepNumberJLabel.setText("*检查工位编号");
        //薛凯修改结束
        ...
        nameJLabel.setMaximumSize(new Dimension(73, 22));
        nameJLabel.setMinimumSize(new Dimension(73, 22));
        nameJLabel.setPreferredSize(new Dimension(73, 22));
        nameJLabel.setHorizontalAlignment(SwingConstants.RIGHT);
        nameJLabel.setHorizontalTextPosition(SwingConstants.RIGHT);
        nameJLabel.setText("*检查工位名称");
        ...
        numJTextField.setMaximumSize(new Dimension(6, 15));
        nameJTextField.setMaximumSize(new Dimension(6, 15));

        //add by wangh on 20070201
        descNumJTextField.setMaximumSize(new Dimension(6, 15));
...
//            jTabbedPanel.add(extendJPanel3, "过程FMEA");
            jTabbedPanel.add(extendJPanel4, "检查作业指导书");
        }
//20080820
...
//                                            new Insets(2, 0, 2, 0), 0, 0));
        ...
        localize();
        initStepTypeTable();
        splitJPanel.setDividerLocation(100);
...
//          CCEnd by leixiao 2008-10-28 原因：解放系统升级 
            ...
            if (processControlTable.get(processType) == null)
            {
                try
                {
                	System.out.println("procedureInfo.getBsoName()=====1111111111111====="+procedureInfo.getBsoName());
