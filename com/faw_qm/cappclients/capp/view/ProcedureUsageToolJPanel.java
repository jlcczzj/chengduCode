/** 生成程序ProcedureUsageToolJPanel.java	1.1  2003/08/28
 * 版权归一汽启明公司所有
 * 本程序属一汽启明公司的私有机要资料
 * 未经本公司授权，不得非法传播和盗用
 * 可在本公司授权范围内，使用本程序
 ...
 * @author 刘明 薛静
 * @version 1.0
 * 问题（1）20080704 徐春英修改 修改原因：为工序工装关联类添加预留属性用
...
public class ProcedureUsageToolJPanel extends ParentJPanel
{
    ...
    //问题（1）20080704 xucy add 修改原因：为工序工装关联添加预留属性用
    /**
     * 工序种类
     */
            ...
            throws Exception
    {
       ...
       // cappAssociationsPanel.setMutliSelectedModel(false);   //Begin CR1
        ...
        //设置列表标题名
//      CCBeginby leixiao 2009-6-24 原因：工序工装面板属性增加
        String args1[] = new String[4];
        args1[0] = "工装编号";
        args1[1] = "工装名称";
        args1[2] = "工装规格";
        args1[3] = "工装标准";
//      CCEndby leixiao 2009-6-24 原因：工序工装面板属性增加
...
//      CCEndby leixiao 2009-6-24 原因：工序工装面板属性增加
        ...
        //CCBegin by liuzc 2009-12-21 原因：工序工装面板属性增加 参见TD号2672 
...
//		     }
        ...
        //CCEnd by liuzc 2009-12-21 原因：工序工装面板属性增加 参见TD号2672 
        //设置添加按钮显示，即可以添加空白行
         //CCBegin SS2
...
//CCEnd SS1
    ...
    class CreateTool extends Thread
    {
        ...
        {
            canSave = false;
            //如果系统中不存在列表中输入的工装编号，则返回对应的消息，询问是否新建
            //工装，如果是，显示工装新建界面，根据访问权限创建申请工装；如果否，返回原位置.
...
//        }
    ...
    /**
     * 如果e中得到的是设备，把与该设备必要关联的工装加入工装列表，此方法在外部调用
     */
