/** 生成程序QmChooser.java    1.0  2003/02/06
 * 版权归一汽启明公司所有
 * 本程序属一汽启明公司的私有机要资料
 * 未经本公司授权，不得非法传播和盗用
 * 可在本公司授权范围内，使用本程序
 * 保留所有权利
 * CR1 2009/12/31 刘玉柱  TD问题2732
 * CR2 2010/01/13 刘玉柱  TD问题2805
 * SS1 调整搜索界面大小 liunan 2014-5-22
 */
...
/**
 * <p>Title:QmChooser</p>
 * <p>Description:QmChooser有从本地数据库中检索业务对象的能力。
 ...
 * （1）20060824薛静修改 修改原因：为了减少客户段内存增长，释放掉无用的对象
 */
