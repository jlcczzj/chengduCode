/** 生成程序时间 2003/08/11
  ...
  * SS1 郭晓亮  修改服务平台问题，编号：A005-2014-2905
  * SS2 郭晓亮  修改服务平台问题，编号：A005-2014-2923
  */
...
import com.faw_qm.cappclients.capp.view.PaceProcessControlJPanelForBSX;
import com.faw_qm.cappclients.capp.view.StepLinkSouseControlJPanelForBSX;
import com.faw_qm.cappclients.capp.view.StepProcessControlJPanelForBSX;
 ...
 */
public class CappExAttrPanelForBSX extends CappExAttrPanel
{
   ...
   * 问题（1）20080822 xucy  修改原因：将“过程流程”中的相同列表项内容“全部（包括多条列表项内容）”复制到“控制计划”内
   */
  public GroupPanelForBSX groupPanel;

  /**
   * 控制计划面板
   */
  GroupPanelForBSX controlPlanPanel;
 ...
 // 主动属性位置
  ...
  private QMTechnicsIfc technicsIfc=null;
  public static boolean isprocedure = true;
  //CCEnd by leixiao 2008-10-27 原因：解放系统升级 
  
  
  private StepProcessControlJPanelForBSX stepProcessControlJPanelForBSX;
  
  private StepLinkSouseControlJPanelForBSX stepLinkSouseControlJPanelForBSX;
  
  
  private PaceProcessControlJPanelForBSX paceProcessControlJPanelForBSX;
  
  
  private String stepOrPace="";
  
   //CCCBegin SS1
  private JSplitPane splitJPanelcon = new JSplitPane();
  //CCEnd SS1

  /**
   *　构造函数
   */
  public CappExAttrPanelForBSX()
  {
  	super();
   ...
   */
  public CappExAttrPanelForBSX(String bsoName,String secondName,int model,String stepOrPace,QMTechnicsIfc techniceIfc) throws QMException
  {
    try {
      ...
      this.stepOrPace=stepOrPace;
      
      this.technicsIfc=techniceIfc;

      this.isControlPlan = container.isControlPlan();
      System.out.println("this.isControlPlan =="+this.isControlPlan );
  ...
  public CappExAttrPanelForBSX(String bsoName,String secondName,int model,ArrayList vec)throws QMException
  {
	  try {
		  this.editVec = vec;
	      this.model =model;
...
//      jScrollPane1.getViewport().add(attrPanel, null);
       	//CCBegin SS1
//    	this.add(attrPanel, BorderLayout.CENTER);
    	splitJPanelcon.setOrientation(JSplitPane.VERTICAL_SPLIT);
        splitJPanelcon.setBorder(null);
        splitJPanelcon.setMinimumSize(new Dimension(337, 357));
        splitJPanelcon.setOpaque(true);
        splitJPanelcon.setPreferredSize(new Dimension(337, 800));
        splitJPanelcon.setContinuousLayout(true);
        splitJPanelcon.setDividerSize(10);
        splitJPanelcon.setOneTouchExpandable(true);
        splitJPanelcon.setResizeWeight(1.0);
        this.add(splitJPanelcon);
        
        splitJPanelcon.add(attrPanel, JSplitPane.TOP);
    ...
    {
    	 //CCBegin guoguo
    	System.out.println("stepOrPace==========******************************=========="+stepOrPace);
    	if(this.stepOrPace.equals("工序")){
    		//CCBegin SS2
           if(stepProcessControlJPanelForBSX==null)
        	 //CCEnd SS2
                  stepProcessControlJPanelForBSX=new StepProcessControlJPanelForBSX(this.getParentFrame());
           String techType=technicsIfc.getTechnicsType().getCodeContent();
           if (techType.equals("变速箱装配工序")||techType.equals("变速箱装配工艺") ||
     				techType.equals("变速箱机加工序")|| techType.equals("变速箱机加工艺")) {
           this.add(stepProcessControlJPanelForBSX, BorderLayout.NORTH);
           }
    	}else{
    		//CCBegin SS2
    		if(paceProcessControlJPanelForBSX==null)
    			//CCEnd SS2
    		   paceProcessControlJPanelForBSX=new PaceProcessControlJPanelForBSX(this.getParentFrame());
    		 String techType=technicsIfc.getTechnicsType().getCodeContent();
             if (techType.equals("变速箱装配工序")||techType.equals("变速箱装配工艺") ||
       				techType.equals("变速箱机加工序")|| techType.equals("变速箱机加工艺")) {
    		   this.add(paceProcessControlJPanelForBSX, BorderLayout.NORTH);
             }
    	}
        //CCEnd guoguo
      ...
      while(names.hasNext())
      {
        ...
        groupPanel = (GroupPanelForBSX)this.groupMaps.get(name);
    ...
    //CCBegin guoguo
         if(stepLinkSouseControlJPanelForBSX==null)
           stepLinkSouseControlJPanelForBSX=new StepLinkSouseControlJPanelForBSX(this.getParentFrame(),this.getProIfc());
         ...
         if (techType.equals("变速箱装配工序")||techType.equals("变速箱装配工艺") ||
           ...
           //CCBegin SS1
//            this.add(stepLinkSouseControlJPanelForBSX, BorderLayout.SOUTH);
        	 
        	 splitJPanelcon.add(stepLinkSouseControlJPanelForBSX, JSplitPane.BOTTOM);
        	 //CCEnd SS1
         }
      //CCEnd guoguo
    }
  ...
  private void prepareValues(){
    ...
    if(isGroup)
    {
      ...
      {
        name = (String)names.next();
        groupPanel = new GroupPanelForBSX(container,name,false);
        this.groupMaps.put(name, groupPanel);
//        groupPanel.defaultColumnWidths();1111111111111111111111111111111111
    ...
    if(this.isControlPlan)
    {
      this.controlPlanPanel = new GroupPanelForBSX(container,"ControlPlan",true);
       ...
       // 20070205薛静修改
        ...
        public void show(ExtendAttContainer container1)
        {
            ...
            if (isGroup)
            {
                Iterator names = container.getAttGroupNames().iterator();
                String name;
                GroupPanelForBSX gpanel = null;
                while (names.hasNext())
                {
                    name = (String) names.next();
                    gpanel = (GroupPanelForBSX)this.groupMaps.get(name);
...
//      this.controlPlanPanel.show(info,"ControlPane");
  ...
  public  boolean check()
  {
    ...
    if(this.isGroup)
   {
    	Iterator names = container.getAttGroupNames().iterator();
    	String name;
    	GroupPanelForBSX gpanel ;
    	while(names.hasNext()){
    	name = (String)names.next();
    	gpanel = (GroupPanelForBSX)groupMaps.get(name);
    if(!gpanel.check())
      return false;
   }
   }
  ...
  public ExtendAttContainer getExAttr()
  {
    ...
    if(this.isGroup)
    {
    	...
    	while(names.hasNext()){
    	name = (String)names.next();
    	gp = (GroupPanelForBSX)this.groupMaps.get(name);
    ...
    System.out.println("1111111111111111======isControlPlan================================"+isControlPlan);
    if(this.isControlPlan)
   {
    	
     Vector vec = this.controlPlanPanel.getExAttr();
     System.out.println("1111111111111111======================================"+vec.size());
...
//    }
  ...
  //  CCEnd by leixiao 2008-10-27 原因：解放系统升级 
     ...
     * 获得控制计划面板中工序面板
     */
    public StepProcessControlJPanelForBSX getStepProcessControlJPanelForBSX(){
    	
    	
    	return stepProcessControlJPanelForBSX;
     ...
     * @return
     */
    public StepLinkSouseControlJPanelForBSX getStepLinkSouseControlJPanelForBSX(){
    	
    	return stepLinkSouseControlJPanelForBSX;
    }
    /**
     * 获得控制计划中工步面板
     * @return
     */
    public PaceProcessControlJPanelForBSX getPaceProcessControlJPanelForBSX(){
    	
    	return this.paceProcessControlJPanelForBSX;
    }
