 ...
 */
public class ToolZBWNGJController {
	public ToolZBWNGJController() {
	}
	...
	public void printFile(JPanel panel, Vector result, String department,
		...
		String url = "http://"
				...
				+ RemoteProperty.getProperty("routeListTemplate",
						"/PhosphorPDM/template/bsx/") + "zbbwngj.xls";
	//	String url="http:"+"//"+"10.7.64.33"+"/"+"PhosphorPDM"+"/"+"template"+"/"+"zbbwngj.xls";
