 ...
 */
public class ToolZPGJYLBController {
	public ToolZPGJYLBController() {
	}
	...
	public void printFile(JPanel panel, Vector result, String department,
		...
		String url = "http://"
				...
				+ RemoteProperty.getProperty("routeListTemplate",
						"/PhosphorPDM/template/bsx/") + "gjylbd.xls";
		//String url="http:"+"//"+"10.7.64.33"+"/"+"PhosphorPDM"+"/"+"template"+"/"+"zpgjylb.xls";
