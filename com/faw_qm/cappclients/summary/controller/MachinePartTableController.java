 ...
 * @version 1.0
 */
public class MachinePartTableController {
  public MachinePartTableController() {
  }

  /**
   * 根据汇总结果,部门，零件号以及导出目录，获得相应的模板进行填充
   * @param result Vector
   * @param condition String
   * @param path String
   * @param department String
   */
  public void printFile(JPanel panel, Vector result,String partstring ,String department,
                        String path) {
    String url = "http://" +
