...
public class mainMTPanel extends JPanel
{
    ...
    private SummaryMainMTController mtControl;
     ...
     */
    public mainMTPanel(ActionListener control)
    {
        super();
        try
        {
            this.mtControl = (SummaryMainMTController) control;
            jbInit();
            localize();
        }
        catch (Exception ex)
