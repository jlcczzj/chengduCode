...
//  CCBegin by leixiao 2008-10-14 原因：解放升级,增加查看零部件功能 
    JButton viewPartJButton = new JButton();
...
//  CCEnd by leixiao 2008-10-14 原因：解放升级,增加查看零部件功能
    ...
    public SelectPartJDialog(Frame frame) {
    	//begin CR1
        super(frame, "", true);
        //end CR1
        parentFrame = frame;
    ...
    private void jbInit() throws Exception {
        ...
        rightJButton
                .addActionListener(new SelectPartJDialog_rightJButton_actionAdapter(
                        this));
        ...
        rightAllJButton
                .addActionListener(new SelectPartJDialog_rightAllJButton_actionAdapter(
                        this));
        ...
        leftJButton.setText("<");
        leftJButton
                .addActionListener(new SelectPartJDialog_leftJButton_actionAdapter(
                        this));
        ...
        leftAllJButton
                .addActionListener(new SelectPartJDialog_leftAllJButton_actionAdapter(
                        this));
        ...
        //CCBegin by leixiao 2008-10-14 原因：解放升级,增加查看零部件功能
        this.viewPartJButton.setText("查看");
        viewPartJButton.addActionListener(new
                                      SelectPartJDialog_viewPartJButton_actionAdapter(this));
        viewPartJButton.setPreferredSize(new Dimension(65, 23));
        viewPartJButton.setMinimumSize(new Dimension(65, 23));
        viewPartJButton.setMaximumSize(new Dimension(65, 23));
        //CCEnd by leixiao 2008-10-14 原因：解放升级工艺路线
        okJButton.setText("确定(Y)");
        okJButton
                .addActionListener(new SelectPartJDialog_okJButton_actionAdapter(
                        this));
        ...
        cancelJButton
                .addActionListener(new SelectPartJDialog_cancelJButton_actionAdapter(
                        this));
...
//	  CCBegin by leixiao 2008-11-10 原因：解放升级工艺路线,增加工艺路线按结构添加零件时，在零件结构选择树上显示相关艺准 	        
        partTreePanel.isShowRoute(true);
//  	  CCEnd by leixiao 2008-11-10 原因：解放升级工艺路线,增加工艺路线按结构添加零件时，在零件结构选择树上显示相关艺准 
        ...
        sourceComboBox.setEnumeratedTypeClass(Class
                .forName("com.faw_qm.part.util.ProducedBy"));
        sourceComboBox
                .addActionListener(new SelectPartJDialog_sourceComboBox_actionAdapter(
                        this));

        typeComboBox.setEnumeratedTypeClass(Class
                .forName("com.faw_qm.part.util.QMPartType"));
        ...
        jPanel2.add(productStructureJLabel, new GridBagConstraints(0, 0, 1, 1,
        ...
        jPanel4.add(rightAllJButton, new GridBagConstraints(0, 1,
                GridBagConstraints.REMAINDER, 1, 0.0, 0.0,
                GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(
                        8, 0, 0, 0), 0, 0));
        jPanel4.add(leftJButton, new GridBagConstraints(0, 2, 1, 1, 0.0, 0.0,
                GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(
                        8, 0, 0, 0), 0, 0));
        jPanel4.add(leftAllJButton, new GridBagConstraints(0, 3, 1, 1, 0.0,
                0.0, GridBagConstraints.CENTER, GridBagConstraints.NONE,
                new Insets(8, 0, 0, 0), 0, 0));
        jPanel4.add(rightJButton, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0,
                GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(
                        0, 0, 0, 0), 0, 0));
//      CCBegin by leixiao 2008-10-14 原因：解放升级,增加查看零部件功能                
        jPanel4.add(viewPartJButton, new GridBagConstraints(0, 4, 1, 1, 0.0, 0.0
...
//      CCEnd by leixiao 2008-10-14 原因：解放升级,增加查看零部件功能             
        ...
        this.getContentPane().add(
                ...
                new GridBagConstraints(1, 1, 1, 1, 0.0, 0.0,
                        ...
                        new Insets(0, 0, 0, 0), 3, 181));
        jPanel1.add(sourceCheckBox, new GridBagConstraints(0, 0, 1, 1, 0.0,
                0.0, GridBagConstraints.SOUTHEAST, GridBagConstraints.NONE,
                new Insets(8, 0, 0, 0), 0, 0));
        jPanel1.add(sourceComboBox, new GridBagConstraints(1, 0, 1, 1, 1.0,
                0.0, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL,
                new Insets(8, 0, 0, 0), 0, 0));
        jPanel1.add(typeCheckBox, new GridBagConstraints(0, 1, 1, 2, 0.0, 0.0,
                GridBagConstraints.SOUTHEAST, GridBagConstraints.NONE,
                new Insets(8, 0, 0, 0), 0, 0));
        jPanel1.add(typeComboBox, new GridBagConstraints(1, 2, 1, 1, 0.0, 0.0,
                GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL,
                new Insets(8, 0, 0, 0), 0, 0));
        jPanel1.add(jCheckBox3, new GridBagConstraints(0, 3, 2, 1, 0.0, 0.0,
   ...
   public void setConfigSpec(ConfigSpecItem configSpecItem) {
    ...
    private void addProductToTree(QMPartMasterIfc product) {
        ...
        /*
         * Class[] c = { MasteredIfc.class}; Object[] obj = { product};
         * Collection cc = (Collection)
         * RParentJPanel.useServiceMethod("VersionControlService",
         * "allVersionsOf", c, obj); if (cc != null && cc.size() != 0) {
         * QMPartMasterInfo[] partMasters=new QMPartMasterInfo[cc.size()]; int
         * i=0; for (Iterator iter = cc.iterator(); iter.hasNext(); ) {
         * partMasters[i] = (QMPartMasterInfo) ( (QMPartIfc) iter.next()).
         * getMaster(); } System.out.println("零件主信息partMasters="+partMasters); }
         */
     ...
     */
    /**
     * private void addProductToTree(QMPartMasterIfc product) { try { Class[] c =
     * {QMPartMasterIfc.class}; Object[] obj = {product}; Collection cc =
     * (Collection)RParentJPanel.useServiceMethod("TechnicsRouteService","getSubPartMasters",c,obj);
     * for(Iterator iter = cc.iterator();iter.hasNext();) { PartMasterTreeObject
     * treeobj = new PartMasterTreeObject((QMPartMasterIfc)iter.next());
     * partTreeJPanel.addNode(treeobj); } } catch(QMException ex) { String
...
//              CCEnd by leixiao 2009-1-12 原因：解放升级工艺路线，记录当前零件id
     ...
     */
    /**
     * public Vector getSelectedParts() { Vector v = new Vector();
     * //获得树上所有被选中的节点 PartMasterTreeNode[] nodes =
     * partTreeJPanel.getSelectedNodes(); if(nodes!=null && nodes.length>0) {
     * for(int i=0;i <nodes.length;i++) { if(nodes[i].getObject()!=null) {
     * QMPartMasterInfo masterInfo =
     * (QMPartMasterInfo)nodes[i].getObject().getObject(); v.add(masterInfo); } }
     * //如果是二级路线，需进行检查
     * if(this.myRouteList.getRouteListLevel().equals(RouteListLevelType.SENCONDROUTE.getDisplay())) {
     * Class[] c = {String.class, String.class,Collection.class}; Object[] objs =
     * {myRouteList.getRouteListDepartment(),myRouteList.getProductMasterID(),v};
     * Object[] array = null; try { array =
     * (Object[])RParentJPanel.useServiceMethod("TechnicsRouteService","checkSubParts",c,objs); }
     * catch (QMRemoteException ex) { String title=
     * QMMessage.getLocalizedMessage(RESOURCE,"exception",null);
     * JOptionPane.showMessageDialog(this, ex.getClientMessage(), title,
     * JOptionPane.INFORMATION_MESSAGE); return null; } if(array!=null) { Vector
     * v1 = (Vector)array[0]; //符合条件的零部件主信息 Vector v2 = (Vector)array[1];
     * //不符合条件的零部件主信息 if(v2!=null && v2.size()>0) { String message = "零部件";
     * for(int j=0;j <v2.size();j++) { String partNumber =
     * ((QMPartMasterInfo)v2.elementAt(j)).getPartNumber(); if(j <v2.size()-1)
     * message = message + partNumber+"、"; else message = message + partNumber +
     * "在当前路线表中不能编辑路线。"; }
     * JOptionPane.showMessageDialog(this,message,"通知",JOptionPane.INFORMATION_MESSAGE); }
     * return v1; } } } return v; } /** 获得用户已选择的所有零部件
     *
     * @return 零部件值对象集合
     */
    ...
    public static void main(String[] args) {
        try {
            ...
            SelectPartJDialog frame = new SelectPartJDialog(null);
   ...
   private boolean dofilter(QMPartIfc partInfo) throws QMRemoteException {
...
//            System.out.println("isHasRoute(partInfo)=========="+isHasRoute(partInfo));
    ...
    private boolean dofilterNoRoute(QMPartIfc partInfo) {
      ...
      if (this.typeCheckBox.isSelected()) {
            if (!partInfo.getPartType().toString().equals(
                    this.typeComboBox.getSelectedEnumeratedType().toString())) {
                return false;
            }
        }
        if (this.sourceCheckBox.isSelected()) {
            if (!partInfo.getProducedBy().toString().equals(
                    this.sourceComboBox.getSelectedEnumeratedType().toString())) {
                return false;
            }
        }
        return true;
     ...
     */
    private boolean isHasRoute(QMPartIfc part) throws QMRemoteException {
        ...
        try {
            ...
            return ((Boolean) server.request(info)).booleanValue();
        } catch (QMRemoteException ex) {
            ex.printStackTrace();
            throw ex;
        }
     ...
     * @throws QMRemoteException
     */
    private Vector[] isHasRoute(Vector parts) throws QMRemoteException {
        ...
        try {
            ...
            return (Vector[]) server.request(info);
        } catch (QMRemoteException ex) {
            ex.printStackTrace();
            throw ex;
        }
    ...
    if (selectedNode.equals(partTreePanel.getRoot())
            || selectedNode.getObj().getObject() instanceof MasterIfc) {
        //|| partTreePanel.getRoot().getChildAt(0).equals(selectedNode)) {
        return;
    }
    ...
    if (myRouteList.getRouteListLevel().equals("一级路线")) {
        int j = qMMultiList1.getNumberOfRows();
        for (int jj = 0; jj < j; jj++) {
            String id1 = qMMultiList1.getCellText(jj, 0);
            if (partInfo.getMasterBsoID().equals(id1)) {
                return;
            }
        }
        qMMultiList1.addTextCell(j, 0, partInfo.getMasterBsoID());
        qMMultiList1.addTextCell(j, 1, partInfo.getPartNumber());
        qMMultiList1.addTextCell(j, 2, partInfo.getPartName());

    }
    if (myRouteList.getRouteListLevel().equals("二级路线")) {
        Vector vector = getSubParts();
        QMPartMasterIfc part = null;
        if (vector.size() > 0) {

            for (int i = 0; i < vector.size(); i++) {
                part = (QMPartMasterIfc) vector.elementAt(i);
                int ii = qMMultiList1.getNumberOfRows();
                for (int iii = 0; iii < ii; iii++) {
                    String id1 = qMMultiList1.getCellText(iii, 0);
                    if (part.getBsoID().equals(id1)) {
                        return;
                    }
                }
                qMMultiList1.addTextCell(ii, 0, part.getBsoID());
                qMMultiList1.addTextCell(ii, 1, part.getPartNumber());
...
//add by guoxl on 20080222(把用户在左边零件数中选择的单个零部件添加到列表中，这一功能逻辑错误，所以重新编写)
  void rightJButton_actionPerformed(ActionEvent e) {
    ...
    QMPartInfo partInfo = (QMPartInfo) partTreePanel.getSelected().getObj().
        getObject();
    ...
    if (vecArray[1].size() > 0) {
      for(int i=0;i<vecArray[1].size();i++){
        ...
        JOptionPane.showMessageDialog(this, "所选零件" + partNum.getPartNumber()
                                      + "不符合要求", "提示",
                                      JOptionPane.INFORMATION_MESSAGE);
      }
    }
  ...
  //add by guoxl end
    ...
    private Vector getChild() {
        ...
        if (myRouteList.getRouteListLevel().equals("一级路线")) {
            ...
            Object[] paraObj = {
                    ...
                    (PartConfigSpecIfc) partTreePanel.getConfigSpecItem()
                            .getConfigSpecInfo() };
            try {
                QMPartIfc[] qmPartInfos = (QMPartIfc[]) RParentJPanel
                ...
                if (qmPartInfos != null) {
                    for (int j = 0; j < qmPartInfos.length; j++) {
                        if (qmPartInfos[j].getMaster().getBsoID().equals(
        ...
        } else if (myRouteList.getRouteListLevel().equals("二级路线")) {
            Class[] paraclass = { QMPartMasterIfc.class,
                    PartConfigSpecIfc.class, String.class };
            Object[] paraObj = {
                    partMasterIfc,
                    (PartConfigSpecIfc) partTreePanel.getConfigSpecItem()
                            .getConfigSpecInfo(),
                    myRouteList.getRouteListDepartment() };
            try {
                vec = (Vector) RParentJPanel.useServiceMethod(
                        "TechnicsRouteService", "getAllSubPart", paraclass,
                        paraObj);
...
//  CCBegin by leixiao 2008-10-14 原因：解放升级,增加查看零部件功能
     ...
     * @param e
     */
    void viewPartJButton_actionPerformed(ActionEvent e) {
    	
    QMNode selectedNode = partTreePanel.getSelected();
  //  System.out.println("choosed part" + selectedNode);
    if (selectedNode == null) {
      return;
    }
    if (selectedNode.equals(partTreePanel.getRoot())
    ...
    QMPartInfo partInfo = (QMPartInfo) partTreePanel.getSelected().getObj().
        getObject();
    try {
      BaseValueIfc persistable = partInfo;
      if (persistable == null) {
        return;
      }
...
class SelectPartJDialog_this_windowAdapter extends java.awt.event.WindowAdapter {
  ...
  * <p>Description: </p>
  */
class SelectPartJDialog_rightJButton_actionAdapter implements
  ...
  * <p>Description: </p>
  */
class SelectPartJDialog_leftJButton_actionAdapter implements
        java.awt.event.ActionListener {
    SelectPartJDialog adaptee;
  ...
  * <p>Description: </p>
  */
class SelectPartJDialog_rightAllJButton_actionAdapter implements
        java.awt.event.ActionListener {
    SelectPartJDialog adaptee;
  ...
  * <p>Description: </p>
  */
class SelectPartJDialog_leftAllJButton_actionAdapter implements
        java.awt.event.ActionListener {
    SelectPartJDialog adaptee;
  ...
  * <p>Description: </p>
  */
class SelectPartJDialog_okJButton_actionAdapter implements
        java.awt.event.ActionListener {
    SelectPartJDialog adaptee;
  ...
  * <p>Description: </p>
  */
class SelectPartJDialog_cancelJButton_actionAdapter implements
        java.awt.event.ActionListener {
    SelectPartJDialog adaptee;
...
/*
 * class SelectPartJDialog_partTreePanel_changeConfigItemAdapter implements
 * java.awt.event.ActionListener { SelectPartJDialog adaptee;
 *
 * SelectPartJDialog_partTreePanel_changeConfigItemAdapter(SelectPartJDialog
 * adaptee) { this.adaptee = adaptee; } public void actionPerformed(ActionEvent
 * e) { adaptee.partTreePanel_actionPerformed(e); } }
 */

 /**
  * <p>Title:来源Combo事件监听器</p>
  * <p>Description: </p>
  */
class SelectPartJDialog_sourceComboBox_actionAdapter implements
        java.awt.event.ActionListener {
    SelectPartJDialog adaptee;
...
//CCBegin by leixiao 2008-10-14 原因：解放升级,增加查看零部件功能
class SelectPartJDialog_viewPartJButton_actionAdapter
implements java.awt.event.ActionListener {
SelectPartJDialog adaptee;

SelectPartJDialog_viewPartJButton_actionAdapter(SelectPartJDialog adaptee) {
this.adaptee = adaptee;
}

public void actionPerformed(ActionEvent e) {
adaptee.viewPartJButton_actionPerformed(e);
}
}
//CCEnd by leixiao 2008-10-14 原因：解放升级,增加查看零部件功能
