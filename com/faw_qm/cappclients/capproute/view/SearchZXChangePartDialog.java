...
public class SearchZXChangePartDialog
    extends JDialog {
  ...
  public SearchZXChangePartDialog(Frame frame, String title, boolean modal) {
  ...
  public SearchZXChangePartDialog(Frame frame, String title, boolean modal, boolean isManufacturing,String productID) 
  {
    super(frame, title, modal);
    try 
    {
  ...
  public SearchZXChangePartDialog() {
    this(null, "", false);
  }
  ...
  private void jbInit() throws Exception {
    ...
    jLabel1.setText("搜索更改通知单");
    sourceLabel.setText("更改来源");
    ...
    jButton1.addActionListener(new
    		SearchZXChangePartDialog_jButton1_actionAdapter(this));
    ...
    jButton2.addActionListener(new
    		SearchZXChangePartDialog_jButton2_actionAdapter(this));
    ...
    jButton3.addActionListener(new
    		SearchZXChangePartDialog_jButton3_actionAdapter(this));
    ...
    jButton4.addActionListener(new
    		SearchZXChangePartDialog_jButton4_actionAdapter(this));
    jLabel2.setText("");
    ...
    qMMultiList.setHeadings(new String[] {"id", "编号", "名称", "版本", "视图","partid","状态","标识"});
    qMMultiList.setRelColWidth(new int[] {0, 1, 1, 1, 1, 0,1,1});
  ...
  void jButton1_actionPerformed(ActionEvent e) {
    ...
    try {
      partsColl = (ArrayList) CappRouteAction.
          useServiceMethod(
          "TechnicsRouteService", "getChangeRelateParts", string,
          value);
    }
    ...
    if (sourceJComboBox.getSelectedItem().equals("技术中心")) {
			for (int i = 0; i < partsColl.size(); i++) {
				...
				qMMultiList.addTextCell(i, 6, part.getLifeCycleState()
						.getDisplay());
				qMMultiList.addTextCell(i, 7, "");

			}
		}else{
			for(int i=0;i< partsColl.size();i++){
				String[] part=(String[]) partsColl.get(i);
				qMMultiList.addTextCell(i, 0, part[0]);
				qMMultiList.addTextCell(i, 1,  part[1]);
				qMMultiList.addTextCell(i, 2,  part[2]);
				qMMultiList.addTextCell(i, 3,  part[3]);
				qMMultiList.addTextCell(i, 4,  part[4]);

				qMMultiList.addTextCell(i, 5,  part[5]);
				qMMultiList.addTextCell(i, 6,  part[6]);
				qMMultiList.addTextCell(i, 7,  part[7]);
			}
      ...
      if (x != -1) {
	   ...
	   String[] bsoId2 = { productID };
        ...
        try {
          ...
          //System.out.println("#########==="+partIfc.getPartNumber());
			if (!productID.equals("")) {
...
class SearchZXChangePartDialog_jButton1_actionAdapter
    implements java.awt.event.ActionListener {
  SearchZXChangePartDialog adaptee;

  SearchZXChangePartDialog_jButton1_actionAdapter(SearchZXChangePartDialog
                                                 adaptee) {
...
class SearchZXChangePartDialog_jButton2_actionAdapter
    implements java.awt.event.ActionListener {
  SearchZXChangePartDialog adaptee;

  SearchZXChangePartDialog_jButton2_actionAdapter(SearchZXChangePartDialog
                                                 adaptee) {
    this.adaptee = adaptee;
  }
...
class SearchZXChangePartDialog_jButton4_actionAdapter
    implements java.awt.event.ActionListener {
  SearchZXChangePartDialog adaptee;

  SearchZXChangePartDialog_jButton4_actionAdapter(SearchZXChangePartDialog
                                                 adaptee) {
    this.adaptee = adaptee;
  }
...
class SearchZXChangePartDialog_jButton3_actionAdapter
    implements java.awt.event.ActionListener {
  SearchZXChangePartDialog adaptee;

  SearchZXChangePartDialog_jButton3_actionAdapter(SearchZXChangePartDialog
                                                 adaptee) {
    this.adaptee = adaptee;
  }
