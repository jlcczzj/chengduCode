...
//  private JComboBox levelJComboBox = new JComboBox();
   ...
   private JComboBox stateJComboBox = new JComboBox();
//CCEnd by leixiao 2009-4-1 原因：解放升级工艺路线,类别 
...
//      CCBegin by leixiao 2009-4-1 原因：解放升级工艺路线
    	this.setTitle("搜索艺准/艺毕通知书");
//      CCEnd by leixiao 2009-4-1 原因：解放升级工艺路线
...
//      CCEnd by leixiao 2009-4-1 原因：解放升级工艺路线,艺毕   
        ...
        searchJButton
                .addActionListener(new RouteListSearchJDialog_searchJButton_actionAdapter(
                        this));
        ...
        stopJButton
                .addActionListener(new RouteListSearchJDialog_stopJButton_actionAdapter(
                        this));
        ...
        okJButton
                .addActionListener(new RouteListSearchJDialog_okJButton_actionAdapter(
                        this));
        ...
        cancelJButton
                .addActionListener(new RouteListSearchJDialog_cancelJButton_actionAdapter(
                        this));
    ...
    jPanel2.add(searchJButton, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0,
        ...
        jPanel1.add(jLabel3, new GridBagConstraints(0, 2, 1, 1, 0.0, 0.0,
                GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(0,
                        0, 0, 0), 0, 0));
        //       CCBegin by leixiao 2008-10-10 原因：类别变状态
        jPanel1.add(stateJComboBox, new GridBagConstraints(1, 2, 1, 1, 1.0,
...
//  CCEnd by leixiao 2009-4-1 原因：解放升级工艺路线,级别换成类别  
    /**
     * 设置界面的显示位置
     */
...
//      CCBegin by leixiao 2009-4-1 原因：解放升级工艺路线
        objs[2][0] = stateJComboBox.getSelectedItem();
//      CCEnd by leixiao 2009-4-1 原因：解放升级工艺路线
...
//              qMMultiList.addTextCell(i, 3, routelist.getRouteListLevel());
                qMMultiList.addTextCell(i, 3, routelist.getRouteListState());
//            CCEnd by leixiao 2009-4-1 原因：解放升级工艺路线,级别换成类别 
       ...
       //Begin CR1
        ...
        for (int i = 0; i < objs.length; i++) {
            ...
            if(deleteRouteList.equals(info.getBsoID())){                            
          	  ...
          	  JOptionPane.showMessageDialog(this,"路线表"+"("+
          			  info.getRouteListNumber()+")"+"正在被删除！","提示",
                        JOptionPane.INFORMATION_MESSAGE);
          	  continue;
            }                                                                         
            //End  CR1
...
//    view.getTreePanel().setNodeSelected((RouteListTreeObject)v.elementAt(0));
    ...
    class SearchThread extends QMThread {
        ...
        public SearchThread(ThreadGroup threadgroup,
                RouteListSearchJDialog dialog, boolean flag) {
            super(threadgroup);
            myDialog = dialog;
            isLeave = flag;
        }
  ...
  */
class RouteListSearchJDialog_searchJButton_actionAdapter implements
        java.awt.event.ActionListener {
    private RouteListSearchJDialog adaptee;

    RouteListSearchJDialog_searchJButton_actionAdapter(
  ...
  * <p>Description: </p>
  */
class RouteListSearchJDialog_stopJButton_actionAdapter implements
        java.awt.event.ActionListener {
    private RouteListSearchJDialog adaptee;

    RouteListSearchJDialog_stopJButton_actionAdapter(
            RouteListSearchJDialog adaptee) {
        this.adaptee = adaptee;
    }
  ...
  * <p>Description: </p>
  */
class RouteListSearchJDialog_okJButton_actionAdapter implements
        java.awt.event.ActionListener {
    private RouteListSearchJDialog adaptee;

    RouteListSearchJDialog_okJButton_actionAdapter(
            RouteListSearchJDialog adaptee) {
        this.adaptee = adaptee;
    }
  ...
  * <p>Description: </p>
  */
class RouteListSearchJDialog_cancelJButton_actionAdapter implements
        java.awt.event.ActionListener {
    private RouteListSearchJDialog adaptee;

    RouteListSearchJDialog_cancelJButton_actionAdapter(
            RouteListSearchJDialog adaptee) {
        this.adaptee = adaptee;
    }
 ...
 /**
  * <p>Title：qMMultiList执行适配器</p>
  * <p>Description: </p>
  */
class RouteListSearchJDialog_qMMultiList_actionAdapter implements
        java.awt.event.ActionListener {
    private RouteListSearchJDialog adaptee;

    RouteListSearchJDialog_qMMultiList_actionAdapter(
            RouteListSearchJDialog adaptee) {
        this.adaptee = adaptee;
    }
