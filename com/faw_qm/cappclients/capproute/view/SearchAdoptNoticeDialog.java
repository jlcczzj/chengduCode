...
public class SearchAdoptNoticeDialog
    extends JDialog {
  ...
  public SearchAdoptNoticeDialog(Frame frame, String title, boolean modal) {
  ...
  //CCBegin by liunan 2012-05-22 添加艺毕是否添加生产状态的复选框。如选中则可以搜索并添加生产状态零部件。
  public SearchAdoptNoticeDialog(Frame frame, String title, boolean modal, boolean isManufacturing) 
  {
    super(frame, title, modal);
    try 
    {
  ...
  public SearchAdoptNoticeDialog() {
    this(null, "", false);
  }
  ...
  private void jbInit() throws Exception {
    ...
    //jLabel1.setText("请输入采用更改通知书号进行查询");
    jLabel1.setText("请输入更改通知书号进行查询");
    ...
    jButton1.addActionListener(new
                               SearchAdoptNoticeDialog_jButton1_actionAdapter(this));
    ...
    jButton2.addActionListener(new
                               SearchAdoptNoticeDialog_jButton2_actionAdapter(this));
    ...
    jButton3.addActionListener(new
                               SearchAdoptNoticeDialog_jButton3_actionAdapter(this));
    ...
    jButton4.addActionListener(new
                               SearchAdoptNoticeDialog_jButton4_actionAdapter(this));
    jLabel2.setText("");
  ...
  void jButton1_actionPerformed(ActionEvent e) {
    ...
    try {
      partsColl = (ArrayList) CappRouteAction.
          useServiceMethod(
          "TechnicsRouteService", "getNoticeOrChangeRelatedParts", string,
          value);
    }
...
class SearchAdoptNoticeDialog_jButton1_actionAdapter
    implements java.awt.event.ActionListener {
  SearchAdoptNoticeDialog adaptee;

  SearchAdoptNoticeDialog_jButton1_actionAdapter(SearchAdoptNoticeDialog
                                                 adaptee) {
...
class SearchAdoptNoticeDialog_jButton2_actionAdapter
    implements java.awt.event.ActionListener {
  SearchAdoptNoticeDialog adaptee;

  SearchAdoptNoticeDialog_jButton2_actionAdapter(SearchAdoptNoticeDialog
                                                 adaptee) {
    this.adaptee = adaptee;
  }
...
class SearchAdoptNoticeDialog_jButton4_actionAdapter
    implements java.awt.event.ActionListener {
  SearchAdoptNoticeDialog adaptee;

  SearchAdoptNoticeDialog_jButton4_actionAdapter(SearchAdoptNoticeDialog
                                                 adaptee) {
    this.adaptee = adaptee;
  }
...
class SearchAdoptNoticeDialog_jButton3_actionAdapter
    implements java.awt.event.ActionListener {
  SearchAdoptNoticeDialog adaptee;

  SearchAdoptNoticeDialog_jButton3_actionAdapter(SearchAdoptNoticeDialog
                                                 adaptee) {
    this.adaptee = adaptee;
  }
