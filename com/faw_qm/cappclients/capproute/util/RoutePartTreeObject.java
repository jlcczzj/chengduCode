...
/**
 * <p>
 * Title:工艺路线树中的零部件节点对象.所封装的业务对象为路线表的零部件关联
...
//          this.setNoteText(partmaster.getPartNumber() + "_"
//              + partmaster.getPartName() + "父件" + parentNum + "_"
//              + parentName);
//        }else
//        this.setNoteText(partmaster.getPartNumber() + "_"
//                + partmaster.getPartName()+"父件 无");
...
//                        "/images/route.gif")).getImage();
//            this.setCloseImage(startandImage);
//            this.setOpenImage(startandImage);
//        } else //如果没有路线,则显示空白图标
//        {
//            if (emptyIcon == null)
//                emptyIcon = new ImageIcon(getClass().getResource(
//                        "/images/route_emptyRoute.gif")).getImage();
//            this.setCloseImage(emptyIcon);
//            this.setOpenImage(emptyIcon);
//        }
//    }
//  CCBegin by leix 2008-8-15 原因：解放升级工艺路线
    private void prepareAttrs(BaseValueIfc info) {
        ListRoutePartLinkIfc i = (ListRoutePartLinkIfc) info;

        String routeID = i.getRouteID();
        com.faw_qm.technics.route.model.TechnicsRouteInfo route = null;
        if (routeID != null && routeID.length() > 0) {
          ...
          Object[] obj = {
              routeID};
          route = (com.faw_qm.
                   technics.route.model.TechnicsRouteInfo) useServiceMethod(
        ...
        if (route != null) {
          ...
          this.setNoteText(partmaster.getPartNumber() + "_" +
                           ...
                           "(" + route.getModefyIdenty().getCodeContent() + ")");
        }
        else {
    ...
    private Object useServiceMethod(String serviceName, String methodName,
...
//  CCEnd by leix 2008-8-15 原因：解放升级工艺路线
    /**
     * 设置封装对象
     *
     * @param obj
    ...
    public void setStandardImage() {
        if (startandImage == null)
            startandImage = new ImageIcon(getClass().getResource(
                    ((ListRoutePartLinkIfc) this.getObject())
