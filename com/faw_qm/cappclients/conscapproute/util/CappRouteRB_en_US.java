...
public class CappRouteRB_en_US extends ListResourceBundle
{
    ...
    static final Object contents[][] = {
            ...
            //Titles
            {"exception", "异常信息"}, {"information", "提示"}, {"error", "错误"}, {"warning", "警告"}, {"notice", "通知"}, {"afreshAssignLifeCycle", "重新指定生命周期"}, {"afreshAssignProject", "重新指定工作组"},
            {"findPartTitle", "搜索零部件"}, {"reviseTitle", "修订"}, {"checkInTitle", "检入工艺路线表"},
            ...
            //   "创建,更新,删除,Spacer,检入,检出,撤消检出,Spacer,查看,搜索,Spacer,编辑路线,Spacer,帮助" },
                    "创建,更新,删除,Spacer,检入,检出,撤消检出,Spacer,查看,搜索,Spacer,编辑路线"}, {"routetoolbar.icons",
            ...
            {"routetoolbar.text", "创建,更新,删除,Spacer,刷新,清除,Spacer,查看,选择,Spacer,帮助"},

            {"1", "缺乏必须的资源。"}, {"2", "*并没有发生任何更改。"}, {"3", "编号不能为空。"}, {"4", "名称不能为空。"}, {"5", "缺少必需的字段"}, {"6", "资料夹位置不能为空。"}, {"7", "资料夹路径无效"}, {"8", "所指定的资料夹不是您的个人资料夹"}, {"9", "正在保存..."},
            ...
            {"41", "您尚未检出*，它当前正被*检出。"}, {"42", "您未获得检出*的许可，因为它尚未被检入。"}, {"43", "您尚未检出*。"}, {"44", "*已被*检出。您确实要撤销检出并丢弃所有变更吗？"}, {"45", "请选择欲编辑路线的零部件。"}, {"46", "当前没有可供选择的零部件。"},
            {"47", "*是工作副本的原本，不允许修改！"}, {"48", "单位不能为空。"}, {"49", "零部件*的工艺路线已存在,不能创建新的工艺路线"}, {"50", "零部件*的工艺路线不存在，不能执行当前操作。"}, {"51", "是否退出工艺路线管理器？"}, {"55", "零部件*没有符合配置规范的版本，不可添加。"},};
}
