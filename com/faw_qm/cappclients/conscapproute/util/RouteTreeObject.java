/** 
 * 生成程序 RouteTreeObject.java    1.0    2004/02/19
 * 版权归一汽启明公司所有
 * 本程序属一汽启明公司的私有机要资料
 * 未经本公司授权，不得非法传播和盗用
 * 可在本公司授权范围内，使用本程序
...
/**
 * <p> Title:树节点封装对象的总接口 </p> <p> Description:主要抽象封装了节点对象，节点的图标，节点显示，节点内容和节点的唯一标识信息 </p> <p> Copyright: Copyright (c) 2004 </p> <p> Company: 一汽启明 </p>
 * @author 刘明
 * @version 1.0
 */
