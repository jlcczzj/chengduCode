...
/**
 * <p>Title:路线表的版本比较 </p> <p>Description: 路线表的版本比较</p> <p>Copyright: Copyright (c) 2006</p> <p>Company:一汽启明 </p>
 * @author 刘明
 * @version 1.0 (问题一)20060703 周茁修改 修改原因:性能优化工艺路线表的版本比较,同时修改了版本比较的jsp
 */
public class RouteListVersionCompare
{
    ...
    public Vector getLinkIDVector()
    {
        ...
        try
        {
            ...
            // （问题一)20060703 周茁 zz 修改 修改原因:性能优化工艺路线表的版本比较,同时修改了版本比较的jsp
            // Map map = routeService.compareIterate(myTechnicsCollection);
            if(map == null)
            {
                map = routeService.compareIterate(myTechnicsCollection);
