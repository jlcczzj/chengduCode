        ...
        MaterialStructureIfc
{
 ...
 //CCBegin SS1
    ...
    public String getBeforeMaterial(){
    	 return materialStructureMap.getBeforeMaterial();
    }
    /**
     * 设置替换前零件号。
     * @param flag 替换前零件号。
    ...
    public void setBeforeMaterial(String beforeMaterial){
    	materialStructureMap.setBeforeMaterial(beforeMaterial);
    }
    ...
    public  float getBeforeQuantity(){
    	 return materialStructureMap.getBeforeQuantity();
    }
    /**
     * 设置替换前数量。
     * @param flag 替换前数量。
    ...
    public void setBeforeQuantity(float bquantity){
    	materialStructureMap.setBeforeQuantity(bquantity);
    }
    //CCEnd SS1
