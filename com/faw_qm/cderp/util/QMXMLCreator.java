 ...
 * 可在本公司授权范围内使用本程序
 * 保留所有权利
 * SS1 文件名称出现“前准”ftp无法识别，由于解放服务器有问题引起，所以将“前准”替换为“QZ” 2015-12-01
 */
...
public final class QMXMLCreator
{
    ...
    public final String createDoc(final BaseValueIfc publishSourseObject,
            final List dataList,String publishFathName,int lsh) throws IOException
    {
...
//        System.out.println("wwwewsdcccccccccccccc========="+a);
        ...
        for (int j = 0; j < dataList.size(); j++)
        {
            ...
            {
                xmlFileName = ((QMXMLDesc) data).getFilenumber();
             

                xmlFileName=xmlFileName + ".xml";
                System.out.println("xmlFileName111111111111111======="+xmlFileName);
            }
        }
...
//        str8=str1+str2+str3;
        ...
        //CCEnd SS1
        System.out.println("xmlFileNamexmlFileNamexmlFileName22222222222==========="+xmlFileName);
...
//        System.out.println("sssssssssssssssssss11111111111111111==="+str8);
...
//        System.out.println("ddddddddddddddddddddddddd222222222222222222222222222222222222ddddddddd===");
                        ...
                        for (int m = 0; m < record.getColList().size(); m++)
                        {
                            ...
                            if(col.getValue() == null)
                            {
                                recordElem.addElement("col").addAttribute("id",
                                        col.getId()).addText("");
                                //System.out.println("col.getId()="+col.getId());
                            }
                            else
                            {
                            	// System.out.println("col.getId()="+col.getId());
