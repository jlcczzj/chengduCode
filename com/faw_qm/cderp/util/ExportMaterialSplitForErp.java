...
//					System.out.println("iiiiiiiiiiiiiiiiiiiiii=========="+ii);
			     ...
			     String k0 = RemoteProperty.getProperty("com.faw_qm.cderp.routecode." + ifc.getRouteCode());
...
//			    		 System.out.println("ddddddddddddddddd"+vvv);
			    	 ...
			    	 for(int dd =0 ;dd<vvv.size();dd++){
			    		 ...
			    		 String kkkkk0=RemoteProperty.getProperty("com.faw_qm.cderp.routecode." + ifcdd.getRouteCode());
...
//    				System.out.println("sssssssssssssssss==========--------------"+xc);
    				String xc2 = RemoteProperty.getProperty("com.faw_qm.cderp.routecode." + xc);
