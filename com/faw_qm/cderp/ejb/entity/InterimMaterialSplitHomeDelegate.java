/**
 * 生成程序InterimMaterialSplitHomeDelegate.java	1.0              2007-9-25
 * 版权归启明信息技术股份有限公司所有
 ...
 * @version 1.0
 */
public class InterimMaterialSplitHomeDelegate implements BsoHomeDelegate
{
    /**
     * 
     */
    public InterimMaterialSplitHomeDelegate()
    {
        super();
    }

    private InterimMaterialSplitHome home = null;
    ...
    {
        if(!(obj instanceof InterimMaterialSplitHome))
        {
            Object[] objs = {obj.getClass(), "JFInterimMaterialSplitHome"};
            throw new QMRuntimeException(
                    "com.faw_qm.framework.util.FrameworkResource", "70", objs);
        }
        home = (InterimMaterialSplitHome) obj;
    }
}
