 ...
 * @version 1.0
 */
public class PublishRouteForErpHomeDelegate implements BsoHomeDelegate
{
    /**
     * 
     */
    public PublishRouteForErpHomeDelegate()
    {
        super();
    }

    private PublishRouteForErpHome home = null;
    ...
    {
        if(!(obj instanceof PublishRouteForErpHome))
        {
            Object[] objs = {obj.getClass(), "CDPublishRouteForErpHome"};
            throw new QMRuntimeException(
                    "com.faw_qm.framework.util.FrameworkResource", "70", objs);
        }
        home = (PublishRouteForErpHome) obj;
    }
}
