/**
 * 生成程序MaterialSplitHomeDelegate.java	1.0              2007-9-25
 * 版权归启明信息技术股份有限公司所有
 ...
 * @version 1.0
 */
public class MaterialSplitHomeDelegate implements BsoHomeDelegate
{
    /**
     * 
     */
    public MaterialSplitHomeDelegate()
    {
        super();
    }

    private MaterialSplitHome home = null;
    ...
    {
        if(!(obj instanceof MaterialSplitHome))
        {
            Object[] objs = {obj.getClass(), "CDMaterialSplitHome"};
            throw new QMRuntimeException(
                    "com.faw_qm.framework.util.FrameworkResource", "70", objs);
        }
        home = (MaterialSplitHome) obj;
    }
}
