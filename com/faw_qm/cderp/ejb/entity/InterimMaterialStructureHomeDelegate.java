/**
 * 生成程序InterimMaterialStructureHomeDelegate.java	1.0              2007-9-25
 * 版权归启明信息技术股份有限公司所有
 ...
 * @version 1.0
 */
public class InterimMaterialStructureHomeDelegate implements BsoHomeDelegate
{
    /**
     * 
     */
    public InterimMaterialStructureHomeDelegate()
    {
        super();
    }

    private InterimMaterialStructureHome home = null;
    ...
    {
        if(!(obj instanceof InterimMaterialStructureHome))
        {
            Object[] objs = {obj.getClass(), "JFInterimMaterialStructureHome"};
            throw new QMRuntimeException(
                    "com.faw_qm.framework.util.FrameworkResource", "70", objs);
        }
        home = (InterimMaterialStructureHome) obj;
    }
}
